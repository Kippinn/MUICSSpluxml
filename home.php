<?php include(dirname(__FILE__).'/header.php'); ?>
		...
		<div class="mh-home-columns clearfix">
			<div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-home-area-3">
				...
				<div id="mh_custom_posts-4" class="mh-widget mh-home-3 mh_custom_posts">
					<h4 class="mh-widget-title">
						<span class="mh-widget-title-inner">
							<a href="index.php?categorie3/" class="mh-widget-title-link">
								Tutoriels
							</a>
					</span>
					</h4>
			...
			<div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-margin-left mh-home-area-4">
				<div id="mh_custom_posts-2" class="mh-widget mh-home-4 mh_custom_posts">
					<h4 class="mh-widget-title">
						<span class="mh-widget-title-inner">
							<a href="index.php?categorie2/" class="mh-widget-title-link">
								Vidéos
							</a>
					</span>
					</h4>
				...
				<div id="mh_custom_posts-5" class="mh-widget mh-home-4 mh_custom_posts">
					<h4 class="mh-widget-title">
						<span class="mh-widget-title-inner">
							<a href="index.php?categorie4/" class="mh-widget-title-link">
								On en parle ?
							</a>
					</span>
					</h4>
		...
		<div id="text-2" class="mh-widget mh-home-5 mh-widget-col-2 widget_text" style="">
			<h4 class="mh-widget-title"><span class="mh-widget-title-inner">Bienvenue sur le blog Kube17 !</span></h4>
			<div class="textwidget">
				<div style="font-size: 13px; background: #f6f6f6; padding: 20px; margin-bottom: 20px;">
					Bienvenue sur ce blog :D N'hésitez pas à lire tout ce que vous voulez, c'est cadeau !
				</div>
			</div>
		</div>
	</div>
